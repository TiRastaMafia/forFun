...
[например](https://media.tproger.ru/uploads/2018/02/git-gif.svg)
...
![1](https://media.tproger.ru/uploads/2019/02/commit-history-970x386.jpg)
...
![2](https://media.tproger.ru/uploads/2019/02/file-system-git-970x728.jpg)
...
Наконец, git rm <файл> отменяет отслеживание файла и удаляет его из рабочей директории, опция --cached позволит сохранить ![файл](https://media.tproger.ru/uploads/2019/02/manipulate-files-3a5894bb13482084888f9dbffc12737c.svg).
...
![4](https://media.tproger.ru/uploads/2019/02/push-pull-970x362.jpg)
...
![](https://media.tproger.ru/uploads/2019/02/branching-970x435.jpg)
...
![](https://media.tproger.ru/uploads/2019/02/merge-970x441.jpg)
...
|:----|:----|
| 1 | <<<<<<< HEAD:index.html | 
| 2 | Everything above the ==== is the version in master. | 
| 3 | ======= | 
| 4 | Everything below the ==== is the version in the test branch. | 
| 5 | >>>>>>> test:index.html | 
...
![](https://media.tproger.ru/uploads/2019/02/merge-conflict-fb93bb0c2e43c58be2f41a0de5a8457b.svg)
...
! [](https://media.tproger.ru/uploads/2019/02/rebase-970x371.jpg)
...
Символ * рядом с файлом означает, что команда изменит его статус (подготовлен/неподготовлен в зависимости от того, происходит ли обновление или откат). Если нажать Enter, не введя ничего ни в одном из под-меню команды, то все файлы перейдут в (не)подготовленное состояние. Создание патчей доступно в интерактивной консоли и через команду git add -p.
    ...
    Предложение уникальное для 4 ветки